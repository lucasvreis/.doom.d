(custom-set-variables
 ...
 '(warning-suppress-log-types '((lsp-on-idle-hook))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(fixed-pitch ((t (:font #<font-spec nil nil JetBrains\ Mono nil nil normal nil nil 17 nil nil nil nil>))))
 '(font-lock-comment-face ((t (:slant italic))))
 '(font-lock-keyword-face ((t (:slant oblique))))
 '(variable-pitch ((t (:font #<font-spec nil nil Noto\ Sans nil nil nil nil nil nil nil nil nil nil>)))))
